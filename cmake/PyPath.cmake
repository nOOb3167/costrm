...
function(costrm_define_pyvars PYPATH)
	...
	costrm_get_pyvers(${PYPATH} M)
	message(STATUS "Found Python Version [${M}]")
	set(LIBR ${PYPATH}/python${M}.dll)
	set(LIBD ${PYPATH}/python${M}_d.dll)
	costrm_check_file_exists(${LIBR})
	costrm_check_file_exists(${LIBD})

	set(PYLIBSTEM python${M}$<$<CONFIG:Debug>:_d>)

	set(COSTRM_PYPATH "${COSTRM_PYPATH}" PARENT_SCOPE)
	set(COSTRM_PYVERS "${M}" PARENT_SCOPE)
	set(COSTRM_PYINC ${PYPATH}/include PARENT_SCOPE)
	set(COSTRM_PYLIBSTEM "${PYLIBSTEM}" PARENT_SCOPE)
